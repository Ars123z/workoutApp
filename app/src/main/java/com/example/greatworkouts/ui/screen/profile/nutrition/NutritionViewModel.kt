...
class NutritionViewModel(val healthConnectManager: HealthConnectManager): ViewModel() {
    ...
    var sessionsList: MutableState<List<NutritionRecord>> = mutableStateOf(listOf())
    ...
    fun insertTotalCaloriesBurnedRecord() {
        viewModelScope.launch {
            tryWithPermissionsCheck {
                ...
                healthConnectManager.writeNutritionRecord(startOfSession, endOfSession)
    ...
    private suspend fun readTotalCaloriesBurned() {
        ...
        sessionsList.value = healthConnectManager.readNutritionRecord(start.toInstant(), now)
    }
    ...
    companion object {
        val factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                NutritionViewModel(healthConnectManager)
            }
        }
    }
}